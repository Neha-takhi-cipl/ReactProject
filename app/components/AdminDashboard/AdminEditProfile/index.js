...
class AdminEditProfile extends React.Component { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
    this.state = {
      show: false,
  ...
  render() {
    ...
    return (
      <div>
        <div className="AdminEditProfile desktop">
        ...
        <div className="AdminEditProfile mobile">
          {/* <LogoutDialog visible={this.state.logoutModal} closeLogoutModal={this.closeLogoutModal} logout={this.logout} /> */}
