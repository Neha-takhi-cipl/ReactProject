...
class ItiOther extends React.Component { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
      ...
      <div className="itiOther">
        <BottomBox>
          <div className="departDetails">
            <form className="optional">
              <div className="formGroup">
                ...
                /> : <input value={formData.startDate.format('DD/MM/YY')} readOnly={(editMode && !isEditable)} onChange={(evt) => { this.changeValue(evt.target.value, 'startDate'); }} className="formInput depart" type="text" placeholder="Date*" />}
              ...
              <div className="optionalDetails">
                ...
                <div className="formGroup">
                  <input value={formData.duration} readOnly={(editMode && !isEditable)} onChange={(evt) => { this.changeValue(evt.target.value, 'duration'); }} className="formInput" type="text" placeholder="Duration" />
                </div>
                <div className="formGroup">
              ...
              {(!isEditable && editMode) && <div className="EditMode">
                <button onClick={() => { this.setState({ isEditable: true }); }} type="button" value="Edit"><FormattedMessage {...messages.edit} /></button>
          ...
          <div className="nextPreviousWraper" >
            ...
            <img className="midIcon" src={images.itiOther} alt="midIcon" />
